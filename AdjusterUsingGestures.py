...
if not cap.isOpened():
    print("Error: Couldnt not access the webcam.")
    exit()
...
while True:
    ...
    if results.multi_hand_landmarks and results.multi_handedness:
        for i, hand_landmarks in enumerate(results.multi_hand_landmarks):
            hand_label = results.multi_handedess(i).classification[0].label
            ...
            index_pos = (int(thumb_tip.x * w), int(index_tip.y * h))
